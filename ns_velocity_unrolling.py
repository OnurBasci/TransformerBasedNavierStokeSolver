...
ntrain = 40
ntest = 10
T_in = 20  #the size of training
T = 20  #the size of labels
...
def main():
    ...
    if eval:
        ...
        for ep in range(args.epochs):
            ...
            if ep%40 == 0 and ep >= 40 and look_ahead <= max_look_ahead:
                look_ahead += 1
                offset = step * look_ahead
                model.n = look_ahead
            ...
            for i, (x, fx, yy) in enumerate(train_loader):
                ...
                #print("Epoch {} , train_step_loss:{:.5f}".format(ep, train_l2_step))
